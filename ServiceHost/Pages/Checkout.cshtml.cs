...
[Authorize]
public class CheckoutModel(ICartCalculatorService cartCalculatorService, ICartService cartService,
        IProductQuery productQuery, IOrderApplication orderApplication, IZarinPalFactory zarinPalFactory) : PageModel
{
    public Cart Cart = new();
    public const string CookieName = "cart-items";
    private readonly ICartService _cartService = cartService;
    private readonly IProductQuery _productQuery = productQuery;
    private readonly IZarinPalFactory _zarinPalFactory = zarinPalFactory;
    private readonly IOrderApplication _orderApplication = orderApplication;
    private readonly ICartCalculatorService _cartCalculatorService = cartCalculatorService;
